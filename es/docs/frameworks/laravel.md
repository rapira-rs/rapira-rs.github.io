...
El modo en sí no es el impedimento: [Symfony](/es/docs/frameworks/symfony) y [Yii3](/es/docs/frameworks/yii3) mantienen sus aplicaciones residentes en ese mismo modo [SAPI Worker](/es/docs/worker). Lo que falta es el manejo del estado entre peticiones específico de Laravel.
