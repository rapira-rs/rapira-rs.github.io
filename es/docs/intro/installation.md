...
En ambos casos, comprueba el archivo contra `rapira-v0.6.0-SHA256SUMS.txt` antes de instalar; los comandos están en [Comprobar las sumas de verificación](#comprobar-las-sumas-de-verificacion).
