...
tagline: Un servidor para aplicaciones PHP, escrito en Rust.
pitch: No es un artefacto de vibe coding, sino una arquitectura pensada y código escrito con cuidado, con años de RoadRunner detrás.
