...
Выполните `npm ci`, чтобы установить зафиксированные зависимости. Затем выполните `npm run dev`.
Откройте локальный адрес из вывода команды. Каталоги переводов имеют ту же структуру, что и исходные английские файлы.
