...
Почти ничего из этого в бинарник не вшито. Ничто в Rapira не зависит от того, где лежит ваша конфигурация и что управляет процессом, так что раскладка ниже — соглашение, которое вводит эта страница и на которое опирается остальная документация. Сначала доставьте бинарник на машину, об этом рассказывает [Установка](/ru/docs/installation).
...
Пакеты `.deb` и `.rpm` кладут на машину бинарник и встроенный в него рантайм PHP, и больше ничего: **ни юнита службы, ни `php.ini`** (точный список файлов есть в разделе [Установка](/ru/docs/installation)). И то и другое относится к политике конкретной установки, а пакет, который принёс бы их с собой, при каждом обновлении затирал бы ваши правки.
