...
В [режиме воркера](/ru/docs/execution-modes) процесс остаётся резидентным, поэтому медленная утечка, незаметная под php-fpm, копится от запроса к запросу. От этого защищают две настройки:
