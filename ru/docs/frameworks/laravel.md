...
Дело не в самом режиме: [Symfony](/ru/docs/frameworks/symfony) и [Yii3](/ru/docs/frameworks/yii3) держат свои приложения резидентными в том же [режиме воркера](/ru/docs/worker). Не хватает специфичной для Laravel работы с состоянием между запросами.
